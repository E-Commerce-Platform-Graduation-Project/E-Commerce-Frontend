<template>
  <div class="products-container">
    ...
    <div v-for="product in products" :key="product.id" class="product-row"
      :class="{ 'disabled-product': !product.is_active }" @click="$emit('view-details', product)">
      <div class="product-info">
        <img :src="product.displayImage" class="product-image" alt="Product Image" @error="onImageError">
...
/* Reverted to original grid layout for 8 columns */
.product-header,
.product-row {
  display: grid;
...
/* Other styles like toggle switch, badge, etc. remain the same */
.badge {
