<template>
  <div class="container-fluid mobile-orders-container px-4 py-4">
    ...
    <div v-else-if="filteredOrders.length > 0" class="orders-wrapper">
      <div class="table-scroll-container">
        <OrdersList :orders="filteredOrders" @view-details="openOrderDetailsModal"
    ...
    <div v-if="!isLoading && !error && totalOrders > 0" class="pagination-wrapper">
...
const fetchOrdersWithFilters = () => {
  updateUrlParams();
  orderStore.fetchOrders({ page: currentPage.value, search: searchQuery.value });
};
...
/* Mobile scroll hint and wrapper */
.orders-wrapper {
  position: relative;
  width: 100%;
  overflow: visible;
